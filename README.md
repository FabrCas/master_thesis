...
The full treatment of this research study is covered on this [pdf file](https://github.com/FabrCas/master_thesis/blob/main/thesis.pdf).
...
Single modules for deepfake and OOD detection, i.e. ood_detector.py, can be utilized following procedure in launch_*.py files.  An example:
```python
