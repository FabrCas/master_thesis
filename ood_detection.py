...
class Baseline(OOD_Classifier):             # No model training necessary (Empty model forlder)
    """
        ...
        Intuition: an higher MSP should be related to In-Distribution samples, a lower one instead to Out-Of-Distribution
...
class Abnormality_module(OOD_Classifier):   # model to train necessary 
    ...
    Intuition: define a custom model that uses several information from the classifier (softmax probs, encoding, residual) to
